...
namespace CMPG223_Group4_Project
{
    public partial class StaffForm : Form
    {
        ...
        private void SaveStaff(SaveMode mode)
        {
            ...
            string password = txtPass.Text; // if empty on UPDATE, we won't change it
        ...
        private void DataGrid_Staff_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
